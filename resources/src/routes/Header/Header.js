...
import './header.css';
import { Menu,  Dropdown, Icon,Input,Avatar,Badge,Popover,Modal,message} from 'antd';
...
class Header extends Component {
  ...
  componentDidMount(){
    ...
    if(this.props.url=='https://yun.colourlife.com'){//正式
      var _openUrl="https://open.colourlife.com"
    }else{//测试
      var _openUrl="http://open.test.colourlife.com"
    }
    if(access_token){
